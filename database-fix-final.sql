...
-- Execute each section separately for best results

-- PART 1: CREATE IMPROVED settle_match_escrow FUNCTION
-- =====================================================
...
-- PART 2: CREATE IMPROVED settle_team_match_escrow FUNCTION
-- =====================================================
...
-- PART 3: FIX admin_set_match_winner FUNCTION
-- =====================================================
...
-- PART 4: CREATE CLEANUP FUNCTION FOR EXISTING DUPLICATES
-- =====================================================
...
SELECT 'Cleaning up existing duplicates...' as status;
...
-- =====================================================
-- SEPARATE COMMAND: CREATE UNIQUE INDEX
-- =====================================================
-- Run this SEPARATELY outside of a transaction:
-- CREATE UNIQUE INDEX IF NOT EXISTS idx_transactions_unique_match_win
...
-- =====================================================
-- ✅ Added duplicate transaction prevention checks to both functions
-- ✅ Fixed reference code uniqueness with timestamps
-- ✅ Added proper match status updates  
-- ✅ Fixed admin_set_match_winner function completely
-- ✅ Created cleanup function for existing duplicates
-- ✅ Added proper error handling and logging
-- ✅ Executed cleanup of existing duplicates
-- =====================================================
