...
-- 3. CREATE admin_set_match_winner FUNCTION (if missing)
-- =====================================================
...
CREATE UNIQUE INDEX CONCURRENTLY IF NOT EXISTS idx_transactions_unique_match_win
